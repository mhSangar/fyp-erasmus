...
\section{Technologies Used}	
	...
	[include description of camera module]
	
	Camera interface. The Raspberry have a camera connected that will be responsible to take the photos of the user's face.
