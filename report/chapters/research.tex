...
Within machine learning, we can find (\cite{kevin_p_murphy_book}):
\begin{itemize}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=10cm]{research/bio-neuron}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=10cm]{research/ann_neuron_haykin}
...
\begin{itemize}
	...
	\begin{figure}[!ht]
		\centering
		\vspace{0.4cm}
		\includegraphics[width=10cm]{research/linearly_sep_xor}
	...
	\begin{figure}[!ht]
		\centering
		\vspace{0.5cm}
		\includegraphics[width=9cm]{research/parabolic_surface.jpg}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=12cm]{research/multilayer_network}
...
the input data into a new space called the feature space. The formation of this feature space through supervised learning is what distinguishes \glspl{mlp} from the Rosenblatt’s perceptron.
	...
	\begin{figure}[!ht]
		\centering
		\vspace{0.3cm}
		\includegraphics[width=14cm]{research/threshold_vs_sigmoid}
		\caption
		{
...
First of all, we need to explain that the previously explained neural networks and \glspl{cnn} are not at the same level. While the \glspl{ann} seen until now usually have a few hidden layers, \glspl{cnn} belong to the group of networks that apply Deep Learning, where the term "deep" refer to the several hidden layers that are trained to make these such networks learn.
...
\begin{figure}[!ht]
	\centering
	\vspace{0.3cm}
	\includegraphics[width=\textwidth]{research/conv_net_architecture}
...
\begin{figure}[!ht]
	\centering
	\vspace{0.3cm}
	\includegraphics[width=12cm]{research/pooling_process}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\textwidth]{research/convolution}
...
if there is a face in the image, and second, where it is located (\cite{marques2010face}).
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[width=13cm]{research/rowley_network}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[width=6.2cm]{research/fd_statistical_method}
	...
	\begin{enumerate}
		...
		\begin{figure}[!ht]
			\centering
			\vspace{0.15cm}
			\includegraphics[width=10cm]{research/types_haar_features}
		...
		\begin{figure}[!ht]
			\centering
			\includegraphics[width=8cm]{research/application_haar_features}
		...
		\begin{figure}[!ht]
			\centering
			\includegraphics[width=10cm]{research/cascade_decission_tree.png}
...
Finally, the most important feature of Python: it is very easy to learn. It has fewer keywords than other languages, its structure is much simpler and the syntax is can be easily understood with a certain level of English. 
...
\begin{figure}[!ht]
	\centering
	\vspace{0.5cm}
	\includegraphics[width=13cm]{research/TIOBE_python_ranking.png}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=9cm]{research/PYPL_python_ranking.png}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=13cm]{research/Github_python_ranking.png}
